...
//!
//! Ref: https://github.com/nshi/mentat/issues/618 (item 6)
...
use mentat::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: mentat"));
