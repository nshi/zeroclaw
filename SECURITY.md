...
2. **GitHub**: Use [GitHub Security Advisories](https://github.com/nshi/mentat/security/advisories/new)
...
Mentat implements defense-in-depth security:
...
Mentat Docker images follow CIS Docker Benchmark best practices:
...
docker inspect --format='{{.Config.User}}' mentat
# Expected: 65534:65534

# Run with read-only filesystem (production hardening)
docker run --read-only -v /path/to/workspace:/workspace mentat gateway
```
