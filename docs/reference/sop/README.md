...
- CLI `mentat sop` currently manages definitions only: `list`, `validate`, `show`.
...
2. Create a SOP directory, for example:
   ...
   ```text
   ~/.mentat/workspace/sops/deploy-prod/SOP.toml
   ~/.mentat/workspace/sops/deploy-prod/SOP.md
   ```
