...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `mentat onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `mentat onboard` |
| Config exists, just fix channels | `mentat onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `mentat onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `mentat onboard --api-key "sk-..." --provider openrouter`
- Guided onboarding: `mentat onboard`
...
- Validate environment: `mentat status` + `mentat doctor`
