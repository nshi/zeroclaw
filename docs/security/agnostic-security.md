...
| Hardware | RAM | Mentat (base) | Mentat (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, Mentat uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### Mentat's Core Promise: Swap Anything
