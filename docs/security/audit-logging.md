...
## Problem
Mentat logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/mentat/audit.key"
...
mentat audit --user @alice

# Show all high-risk commands
mentat audit --risk high

# Show violations from last 24 hours
mentat audit --since 24h --violations-only

# Export to JSON for analysis
mentat audit --format json --output audit.json
