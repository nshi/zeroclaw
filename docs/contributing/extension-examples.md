...
Mentat's architecture is trait-driven and modular.
...
```rust
// In your crate: use mentat::tools::traits::{Tool, ToolResult};
...
Channels let Mentat communicate through any messaging platform.
...
```rust
// In your crate: use mentat::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects Mentat to a different model API.
...
```rust
// In your crate: use mentat::providers::traits::Provider;
...
```rust
// In your crate: use mentat::memory::traits::{Memory, MemoryEntry, MemoryCategory};
