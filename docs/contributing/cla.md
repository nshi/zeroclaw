...
other form of code submission) to the Mentat repository, you agree to the
terms of this CLA.
...
Mentat that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to Mentat
...
All Contributions accepted into the Mentat project are licensed under
both:
...
By opening a pull request or submitting a patch to the Mentat repository,
...
https://github.com/nshi/mentat/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the Mentat dual-license model.*
