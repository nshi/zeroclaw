# Mentat PR Workflow (High-Volume Collaboration)

This document defines how Mentat handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Mentat/project-native labels.
...
- Confirm any required identity-like wording uses Mentat/project-native terminology.
