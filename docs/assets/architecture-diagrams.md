# Mentat Architecture Diagrams

This document provides visual representations of Mentat's architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways Mentat can be run:**

```mermaid
flowchart TD
    Start[mentat CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[mentat daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[Mentat Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>MENTAT_* env vars]
...
*Generated for Mentat v0.1.0 - Architecture Documentation*
