//! HTTP client for communicating with the Mentat gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://mentat.example.com:9999", None);
        assert_eq!(client.base_url, "https://mentat.example.com:9999");
    }
