//! # Mentat Robot Kit
//!
//! A standalone robotics toolkit that integrates with Mentat for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  Mentat AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use mentat_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of Mentat. It defines its own
//! `Tool` trait that is compatible with Mentat's but doesn't require it.
//!
//! ## Safety
//!
