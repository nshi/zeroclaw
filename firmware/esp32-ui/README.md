# Mentat ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for Mentat edge scenarios on ESP32.
...
3. Connect UI state with Mentat edge/runtime messaging
...
- [Mentat Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
